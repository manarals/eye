...
if file is not None:
    ...
    if class_name in class_meanings:
        st.sidebar.write("Diabetic retinopathy is a progressive eye disease that can lead to vision loss. It occurs when diabetes damages the blood vessels of the retina, the light-sensitive tissue at the back of the eye.")
